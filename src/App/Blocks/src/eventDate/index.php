<?php
/**
 * Server-side rendering of the `dc-events-manager/event-date` block.
 *
 * @package WordPress
 */
namespace DCEventsManager\App\Blocks\Event_Date;

use DCEventsManager\Common\Util\get_nearest_timezone as get_nearest_timezone;

/**
 * Renders the `dc-events-manager/event-date` block on the server.
 *
...
function render( $attributes, $content, $block ) {
	...
	$wrapper_attributes = \get_block_wrapper_attributes( array( 'class' => 'event_date' ) );
...
/**
 * Registers the `dc-events-manager/event-time` block on the server.
 */
function register() {
	\register_block_type(
		__DIR__,
