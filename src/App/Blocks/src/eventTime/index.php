<?php
/**
 * Server-side rendering of the `dc-events-manager/event-time` block.
 *
 * @package WordPress
 */
namespace DCEventsManager\App\Blocks\Event_Time;

use DCEventsManager\Common\Util\get_nearest_timezone as get_nearest_timezone;

/**
 * Renders the `dc-events-manager/event-time` block on the server.
 *
